...
class TypeController extends Controller
{
    ...
    public function store(TypeRequest $request)
    {
        ...
        return redirect()->route('admin.types.index')->with('success' , 'Data Type Berhasil Di tambahkan');
    }
    ...
    public function update(TypeRequest $request, Type $type)
    {
        ...
        return redirect()->route('admin.types.index')->with('edit' , 'Data Berhasil Di Edit');
    }
